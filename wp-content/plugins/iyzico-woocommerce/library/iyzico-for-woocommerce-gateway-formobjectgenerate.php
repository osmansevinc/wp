...
class Iyzico_Checkout_For_WooCommerce_FormObjectGenerate {
	...
	public function generateOption($items,$data,$apiKey,$affiliate) {
		...
		$iyzico->paymentSource                = 'WOOCOMMERCE|'.WOOCOMMERCE_VERSION.'|CARRERA-3.0.0'.$affiliate;
	...
	public function generateOptionPwi($items,$data,$apiKey,$affiliate) {
		...
		$iyzico->paymentSource                = 'WOOCOMMERCE|'.WOOCOMMERCE_VERSION.'|CARRERA-3.0.0|PWI'.$affiliate;
